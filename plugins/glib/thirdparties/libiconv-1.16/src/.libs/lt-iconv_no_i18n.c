...
const char * LIB_PATH_VALUE   = "/cygdrive/c/Programs/kinoko/plugins/glib/thirdparties/libiconv-1.16/lib/.libs:";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "/cygdrive/c/Programs/kinoko/plugins/glib/thirdparties/libiconv-1.16/lib/.libs:/usr/local/lib:/usr/local/bin:";
...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("    PATH=/cygdrive/c/Programs/kinoko/plugins/glib/thirdparties/libiconv-1.16/li", f);
  fputs ("b/.libs:/usr/local/lib:/usr/local/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/cygdrive/c/Programs/kinoko/plugins/glib/thirdparties/libiconv-1.16/l", f);
  fputs ("ib/.libs:$PATH\"\n", f);
  fputs ("\n", f);
